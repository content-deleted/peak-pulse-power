        ...
        public void Update()
        {
            ...
            for (int i = 0; i < particleMax; i++)
            {
                ...
                if (particles[i].IsActive())
                {
                    ...
                    vtx[ax + 0].pos.X = pp.Position.X; vtx[ax + 0].pos.Y = pp.Position.Y; vtx[ax + 0].pos.Z = pp.Position.Z;
                    vtx[ax + 1].pos.X = pp.Position.X; vtx[ax + 1].pos.Y = pp.Position.Y; vtx[ax + 1].pos.Z = pp.Position.Z;
                    vtx[ax + 2].pos.X = pp.Position.X; vtx[ax + 2].pos.Y = pp.Position.Y; vtx[ax + 2].pos.Z = pp.Position.Z;
                    vtx[ax + 3].pos.X = pp.Position.X; vtx[ax + 3].pos.Y = pp.Position.Y; vtx[ax + 3].pos.Z = pp.Position.Z;
